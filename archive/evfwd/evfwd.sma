...
#define SOCKET_ASYNC_FILE "addons/amxmodx/logs/evfwd.log"
...
public http_send(message[], any:...) {
	new p_message[BIGSTRING], p_message1[BIGSTRING], p_ip[64], p_port[16]
	...
	if (g_registered > 0) {
		...
		write_file(SOCKET_ASYNC_FILE, p_message, -1)
	}
}
