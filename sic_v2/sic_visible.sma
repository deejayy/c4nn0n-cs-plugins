#if defined sic_visible_included
    #endinput
#endif

#define sic_visible_included
...
public sic_visible_plugin_init()
{
	g_thdl = create_tr2()
}
...
public sic_visible_is_visible(attacker, victim)
{
	return is_player_visible(attacker, victim, g_thdl)
}
